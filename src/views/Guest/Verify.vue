  ...
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <div class="container">
        ...
        <div style="width: 100%;">
          <div class="ion-margin-bottom mt-4">
            <vue-otp-input :should-auto-focus="true" :num-inputs="6" separator="" class="text-dark"
              inputClasses="otp-input" @on-change="handleOnChange" @on-complete="handleOnChange" />
          </div>
          <ion-button expand="full" class="ion-margin-bottom mb-4" size="large" @click="verifyUser"
            :disabled="otp.length !== 6"><b>PROCEED</b></ion-button>
        ...
        <ion-text v-if="countdown > 0" class="muted">Did not receive the code?
          <b class="text-dark"> Resend in {{ countdown }}s</b>
        </ion-text>
        <ion-text v-else class="muted">Did not receive the code?
          <b @click="resendOtp" class="text-dark"> Resend code</b>
        </ion-text>
      </div>
    </ion-content>
  </ion-page>
...
<script lang="ts">
import {
  IonInput, IonItem, IonList, IonContent, IonToolbar, IonPage, IonHeader,
  IonTitle, IonButton, IonText, IonIcon, IonButtons, IonBackButton, IonLoading
} from '@ionic/vue';
...
export default defineComponent({
  components: {
    VueOtpInput, IonInput, IonItem, IonList, IonContent, IonToolbar, IonPage, IonHeader,
    IonTitle, IonButton, IonText, IonIcon, IonButtons, IonBackButton, IonLoading
  },
  setup() {
