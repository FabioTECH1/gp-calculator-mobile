<template>
  <ion-page>
    <ion-header class="ion-no-border">
      <ion-toolbar>
        <ion-title class="mt-2 text-center border-bottom p-2"><b>Fund Wallet</b></ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ion-padding-top" fullscreen>
      <!-- <div class="container"> -->
      <ion-list>
        <div @click="gotoPage('AccountInfo')">
          <ion-item class="ion-margin">
            <ion-icon :icon="send" class="icon" style="font-size: 40px;"></ion-icon>
            <div class="m-3">
              <h6 class="mb-0"><b class="d-block">Send Money</b></h6>
              <span class="muted footnote">From bank app or internet banking</span>
            </div>
            <ion-icon :icon="chevronForward" class="icon" slot="end"></ion-icon>
          </ion-item>
        </div>
        <div @click="gotoPage('FundByCard')">
          <ion-item class="ion-margin">
            <ion-icon :icon="card" class="icon" style="font-size: 40px;"></ion-icon>
            <div class="m-3">
              <h6 class="mb-0"><b class="d-block">Card</b></h6>
              <span class="muted footnote">Add money with a debit card</span>
            </div>
            <ion-icon :icon="chevronForward" class="icon" slot="end"></ion-icon>
          </ion-item>
        </div>
...
import {
  personOutline, eyeOffOutline, eyeOutline, send,
  chevronForward, card, flash, tv
} from 'ionicons/icons';
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      send, chevronForward, card, flash, tv,
      gotoPage, openLoader,
